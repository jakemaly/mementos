...
ok('Collection control is wrapped in the action treatment', css.includes('.dialogueCollection') && css.includes('padding: 0.65rem 0.75rem 0.75rem') && css.includes('box-shadow: 4px 4px 0 #111'));
